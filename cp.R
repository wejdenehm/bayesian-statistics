rm(list=ls())
df<- read.csv("C:/Users/WEJDENE/Anaconda2/pkgs/scikit-learn-0.20.1-py27hf381715_0/Lib/site-packages/sklearn/datasets/data/boston_house_price_data.csv",header=TRUE)
#check na
any(is.na(badhealth))
